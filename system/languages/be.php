...
function e2l_load_strings () {
  ...
  'er--cannot-register-upload' => 'Не атрымалася зарэгістраваць загружаны файл',
  ...
  'gs--password-reset-link-saved' => 'Спасылка скіду пароля захавана ў файл password-reset.psa у папкі карыстальніка блога на серверы.',
  ...
  'em--reply' => 'Адказаць',
  'em--comment-replied-to' => 'каментар, на які адказаў аўтар',
